...
# We bypass Streamlit entirely and patch the canvas component directly in memory.
                        ...
                        if st.button("Submit Working for AI Marking", use_container_width=True, type="primary"):
                            with st.spinner("Gemini is checking your markup and algebra..."):
                                try:
                                    ...
                                    # Image 2: The Digital Canvas (Re-composit ink over background)
                                    canvas_img = None
                                    if canvas_result.image_data is not None:
                                        ...
                                        canvas_img = Image.alpha_composite(bg, ink_img).convert("RGB")
