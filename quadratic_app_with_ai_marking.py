...
if st.session_state.generating:
    ...
    # STAGE 2: Correct form chosen
    else:
        st.success("✅ Correct form chosen!")
        
        # If AI marking is turned off in Settings
        ...
        # If AI marking is turned ON in Settings
        else:
                        ...
                        if st.button("Submit Working for AI Marking", use_container_width=True, type="primary"):
                            with st.spinner("Gemini is checking your algebra..."):
                                try:
                                    ...
                                    The user is solving for a quadratic graph. 
