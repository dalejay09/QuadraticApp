...
# --- THE ABSOLUTE BEZIER RENDERER (No math, just trust the browser!) ---
def render_strokes_on_image(bg_image, json_data):
    ...
    for obj in json_data["objects"]:
        if obj.get("type") == "path" and "path" in obj:
            ...
            # Read the absolute raw coordinates directly and connect the curves
            for cmd in path:
                command = cmd[0]
                ...
                if command in ['M', 'L']:
                    ...
                    if len(nums) >= 4:
                        ...
                        x, y = nums[2], nums[3]
                        # Plot intermediate points for smooth loops
